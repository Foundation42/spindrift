...
| `gravity <pull>` | `pull` — a literal, or a broadcast knob | `row.vel.y`, add mode | `vel.y += pull · dt`, cells per second², negative is down; a positive pull lifts. |
